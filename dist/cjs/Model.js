...
class Model {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            do {
                try {
                    ...
                    if (this.V3) {
                        result = yield this.table.client[op](cmd);
                    }
                    else {
                        result = yield this.table.client[DocumentClientMethods[op]](cmd).promise();
                    }
                }
                catch (err) {
            ...
            if (op == 'find' || op == 'scan') {
                if (result.LastEvaluatedKey) {
                    ...
                    items.next = () => __awaiter(this, void 0, void 0, function* () {
                        ...
                        return yield this[op](properties, params);
                    });
                }
                else {
    ...
    createUnique(properties, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let field of fields) {
                yield this.table.unique.create({ pk: `${this.name}:${field.attribute}:${properties[field.name]}` }, {
                    transaction,
                    exists: false,
                    return: 'NONE',
                });
            }
            yield this.putItem(properties, params);
    ...
    removeUnique(properties, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let fields = Object.values(this.fields).filter(f => f.unique && f.attribute != hash && f.attribute != sort);
            for (let field of fields) {
                yield this.table.unique.remove({ pk: `${this.name}:${field.attribute}:${properties[field.name]}` }, { transaction });
            }
    ...
    updateByFind(properties, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.update(properties, { retry: true });
        });
    }
    //  Low level API
    /* private */ deleteItem(properties, params = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            let expression = new Expression_js_1.Expression(this, 'delete', properties, params);
            yield this.run('delete', expression);
        });
    }
    /* private */ getItem(properties, params = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            let expression = new Expression_js_1.Expression(this, 'get', properties, params);
            return yield this.run('get', expression);
        });
    }
    /* private */ putItem(properties, params = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            properties = Object.assign({}, properties);
            properties[this.typeField] = this.name;
            if (this.timestamps) {
    ...
    /* private */ updateItem(properties, params = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (expression.fallback) {
                return yield this.updateByFind(properties, params);
            }
